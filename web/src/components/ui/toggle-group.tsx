...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        "group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] data-[spacing=0]:rounded-lg data-[spacing=0]:overflow-hidden data-vertical:flex-col data-vertical:items-stretch",
        className
      )}
      {...props}
    >
