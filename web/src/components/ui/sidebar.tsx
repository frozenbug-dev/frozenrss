  ...
  return (
    <main
      ...
      className={cn(
        ...
        'bg-background md:peer-data-[variant=inset]:shadow-lg',
...
function SidebarGroupLabel({
  ...
  return useRender({
    ...
    props: mergeProps<'div'>(
      {
        className: cn(
          'flex h-8 shrink-0 items-center rounded-lg px-3 text-xs font-semibold text-sidebar-foreground/70 ring-sidebar-ring outline-hidden transition-[margin,opacity] duration-200 ease-linear group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0 focus-visible:ring-2 [&>svg]:size-3.5 [&>svg]:shrink-0',
          className
        ),
      },
      props
...
const sidebarMenuButtonVariants = cva(
  [
    ...
    'transition hover:transition-none!',
