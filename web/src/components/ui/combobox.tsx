...
function ComboboxTrigger({
  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      className={cn("[&_svg:not([class*='size-'])]:size-3.5 active:scale-[0.97] active:duration-100", className)}
      {...props}
    >
      {children}
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        "flex min-h-10 flex-wrap items-center gap-1.5 rounded-md bg-transparent bg-clip-padding px-3 py-1.5 text-sm ring-1 ring-border/50 transition-[color,box-shadow] focus-within:ring-2 focus-within:ring-ring/50 has-aria-invalid:ring-2 has-aria-invalid:ring-destructive/50",
        className
      )}
      {...props}
    />
