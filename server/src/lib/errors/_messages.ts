export const ErrorMessage = {
  InternalError: 'An unknown error occured on our server. Please try again later or contact our team.',
  Forbidden: 'You are not authorized to perform this action.',
  Unauthorized: 'This request is unathenticated. Please provide a valid session.',
